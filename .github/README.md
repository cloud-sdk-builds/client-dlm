...
[`@aws-sdk/client-dlm`](https://www.npmjs.com/package/@aws-sdk/client-dlm/v/3.886.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dlm@3.886.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SHO7+emo5lpna0Hxlby/ldHp+opxtu2L7AZtJzKeDj4f2m/uUAs8ARNg5bmEMHND
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-dlm": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dlm@3.886.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-dlm@3.886.0/index.min.mjs": "sha384-SHO7+emo5lpna0Hxlby/ldHp+opxtu2L7AZtJzKeDj4f2m/uUAs8ARNg5bmEMHND"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-dlm/blob/refs/tags/3.886.0/LICENSE
```
